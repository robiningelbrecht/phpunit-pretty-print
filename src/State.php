...
final class State
{
    ...
    private const TOTAL_TEST_FAILED_COUNT = 'total_test_failed_count';
    ...
    public static function incrementTotalTestFailedCount(): void
    {
        self::incrementCountForKeyWith(self::TOTAL_TEST_FAILED_COUNT, 1);
    }

    public static function getTotalTestFailedCount(): int
    {
        return $GLOBALS[self::TOTAL_TEST_FAILED_COUNT] ?? 0;
    }
